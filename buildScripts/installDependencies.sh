...
sudo apt-get install --yes --allow-unauthenticated  make  libsnappy-dev bzip2 libbz2-dev libjansson-dev zlib1g-dev libncurses5-dev libssl-dev libfuse-dev fuse
