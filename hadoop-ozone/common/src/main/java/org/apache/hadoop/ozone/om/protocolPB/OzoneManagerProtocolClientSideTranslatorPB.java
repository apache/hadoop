...
import org.apache.hadoop.ozone.protocol.proto.OzoneManagerProtocolProtos.RenameFSEntryRequest;
import org.apache.hadoop.ozone.protocol.proto.OzoneManagerProtocolProtos.DeleteFSEntryRequest;
...
public final class OzoneManagerProtocolClientSideTranslatorPB
  ...
  public void renameFSEntry(OmKeyArgs args, String toKeyName)
    ...
    KeyArgs keyArgs = KeyArgs.newBuilder()
        ...
        .setKeyName(args.getKeyName())
        .build();
    RenameFSEntryRequest renameFSEntryRequest =
        RenameFSEntryRequest.newBuilder()
            .setKeyArgs(keyArgs)
            .setToKeyName(toKeyName)
            .build();
    OMRequest omRequest = createOMRequest(Type.RenameFSEntry)
        .setRenameFSEntryRequest(renameFSEntryRequest)
        .build();
    handleError(submitRequest(omRequest));
  }
  ...
  public void deleteFSEntry(OmKeyArgs args, boolean recursive)
    ...
    KeyArgs keyArgs = KeyArgs.newBuilder()
        ...
        .setKeyName(args.getKeyName())
        .build();
    DeleteFSEntryRequest deleteFSEntryRequest =
        DeleteFSEntryRequest.newBuilder()
            .setKeyArgs(keyArgs)
            .setRecursive(recursive)
            .build();
    OMRequest omRequest = createOMRequest(Type.DeleteFSEntry)
        .setDeleteFSEntryRequest(deleteFSEntryRequest)
        .build();
    handleError(submitRequest(omRequest));
  }
