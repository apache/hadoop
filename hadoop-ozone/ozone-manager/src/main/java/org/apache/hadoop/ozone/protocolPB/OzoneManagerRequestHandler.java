...
public class OzoneManagerRequestHandler implements RequestHandler {
  ...
  private SetVolumePropertyResponse handleSetVolumePropertyApply(
    ...
    if (setVolumePropertyRequest.hasQuotaInBytes()) {
      impl.applySetQuota(OmVolumeArgs.getFromProtobuf(
          setVolumePropertyRequest.getVolumeInfo()));
    } else {
      impl.applySetOwner(setVolumePropertyRequest.getOriginalOwner(),
  ...
  private DeleteVolumeResponse handleDeleteVolumeApply(OMRequest omRequest)
    ...
    impl.applyDeleteVolume(deleteVolumeRequest.getVolumeName(),
        deleteVolumeRequest.getOwner(), deleteVolumeRequest.getVolumeList());
