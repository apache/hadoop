...
public class OMMetrics {
  ...
  private @Metric MutableCounterLong numRenameFSEntry;
  private @Metric MutableCounterLong numDeleteFSEntry;
  ...
  private @Metric MutableCounterLong numRenameFSEntryFails;
  private @Metric MutableCounterLong numDeleteFSEntryFails;
  ...
  public void incNumRenameFsEntry() {
    numKeyOps.incr();
    numFSOps.incr();
    numRenameFSEntry.incr();
  }

  public void incNumRenameFsEntryFails() {
    numRenameFSEntryFails.incr();
  }

  public void incNumDeleteFsEntry() {
    numKeyOps.incr();
    numFSOps.incr();
    numDeleteFSEntry.incr();
  }

  public void incNumDeleteFsEntryFails() {
    numDeleteFSEntryFails.incr();
  }
