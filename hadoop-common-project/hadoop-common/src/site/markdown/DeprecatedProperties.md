...
| dfs.nfs.exports.cache.expirytime.millis | nfs.exports.cache.expirytime.millis |
| dfs.nfs.exports.cache.size | nfs.exports.cache.size |
| dfs.nfs.kerberos.principal | nfs.kerberos.principal |
| dfs.nfs.keytab.file | nfs.keytab.file |
| dfs.nfs.rtmax | nfs.rtmax |
| dfs.nfs.wtmax | nfs.wtmax |
| dfs.nfs3.dump.dir | nfs.dump.dir |
| dfs.nfs3.enableDump | nfs.file.dump |
| dfs.nfs3.export.point | nfs.export.point |
| dfs.nfs3.max.open.files | nfs.max.open.files |
| dfs.nfs3.stream.timeout | nfs.stream.timeout |
...
| hadoop.nfs.userupdate.milly | usergroupid.update.millis |
...
| nfs.allow.insecure.ports | nfs.port.monitoring.disabled |
| nfs.static.mapping.file | static.id.mapping.file |
| nfs.usergroup.update.millis | usergroupid.update.millis |
| nfs3.mountd.port | nfs.mountd.port |
| nfs3.server.port | nfs.server.port |
