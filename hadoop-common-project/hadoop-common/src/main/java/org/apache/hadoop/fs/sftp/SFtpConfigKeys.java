...
public class SFtpConfigKeys extends CommonConfigurationKeys {
  public static final String  BLOCK_SIZE_KEY = "sftp.blocksize";
  public static final long    BLOCK_SIZE_DEFAULT = 4*1024;
  public static final String  REPLICATION_KEY = "sftp.replication";
  public static final short   REPLICATION_DEFAULT = 1;
  public static final String  STREAM_BUFFER_SIZE_KEY = "sftp.stream-buffer-size";
  public static final int     STREAM_BUFFER_SIZE_DEFAULT = 1024*1024;
  public static final String  BYTES_PER_CHECKSUM_KEY = "sftp.bytes-per-checksum";
  public static final int     BYTES_PER_CHECKSUM_DEFAULT = 512;
  public static final String  CLIENT_WRITE_PACKET_SIZE_KEY = "sftp.client-write-packet-size";
