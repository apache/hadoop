...
public class LiProtobufRpcEngine extends ProtobufRpcEngine {
  public static final Logger LOG =
      LoggerFactory.getLogger(LiProtobufRpcEngine.class);
  ...
  static void replaceProtocolEngine() {
    ...
    org.apache.hadoop.ipc.Server.rpcKindMap.put(
        ...
        new org.apache.hadoop.ipc.Server.RpcKindMapValue(
            ProtobufRpcEngine.RpcProtobufRequest.class, invoker));

    LOG.info("rpcKind=" + RPC.RpcKind.RPC_PROTOCOL_BUFFER
        + ", rpcRequestWrapperClass=" + ProtobufRpcEngine.RpcProtobufRequest.class
        + ", rpcInvoker=" + invoker);
  }
  ...
  protected static class LiInvoker extends ProtobufRpcEngine.Invoker {
  ...
  public static class LiServer extends ProtobufRpcEngine.Server {
    ...
    static class LiProtoBufRpcInvoker
        extends ProtobufRpcEngine.Server.ProtoBufRpcInvoker {
