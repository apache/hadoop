...
public abstract class ClientBaseWithFixes extends ZKTestCase {
    ...
    static {
        // The 4-letter-words commands are simple diagnostics telnet commands in ZooKeeper.
        // Since ZooKeeper 3.5, these are disabled by default due to security concerns:
        // see https://issues.apache.org/jira/browse/ZOOKEEPER-2693
        // We are enabling them for the tests here, as some tests might still use them
