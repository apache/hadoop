...
public class TestGenericsUtil {
  ...
  public void testToArray() {
    ...
    for (int i = 0; i < arr.length; i++) {
      assertEquals(
             ...
             list.get(i), arr[i], "Array has identical elements as input list");
    }
  }
  ...
  public void testWithEmptyList2() {
    ...
    assertEquals(
           0, arr.length, "Assert list creation w/ no elements results in length 0");
  }
  ...
  public void testGetClass() {
    ...
    assertEquals(
           Integer.class, c, "Correct generic type is acquired from object");
    ...
    assertEquals(
           GenericClass.class, c2, "Inner generics are acquired from object.");
  }
  ...
  public void testIsLog4jLogger() throws Exception {
    ...
    assertTrue(
       GenericsUtil.isLog4jLogger(TestGenericsUtil.class), "The implementation is Log4j");
  }
}
