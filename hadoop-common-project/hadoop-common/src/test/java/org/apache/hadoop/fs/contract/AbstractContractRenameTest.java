...
public abstract class AbstractContractRenameTest extends
  ...
  public void testRenameNewFileSameDir() throws Throwable {
    ...
    assertTrue(
       rename, "rename("+renameSrc+", "+ renameTarget+") returned false");
  ...
  public void testRenameFileOverExistingFile() throws Throwable {
    ...
    assertFalse(
       renameOverwritesDest && renameReturnsFalseOnRenameDestExists, RENAME_OVERWRITES_DEST + " and " +
    ...
    try {
      ...
      if (renameOverwritesDest) {
        assertTrue(
           renamed, expectedTo + "overwrite destination, but got false");
      ...
      assertFalse(
         renameOverwritesDest, expectedTo + "overwrite destination, but got exception");
      assertFalse(
         renameReturnsFalseOnRenameDestExists, expectedTo + "be rejected with false, but got exception");
