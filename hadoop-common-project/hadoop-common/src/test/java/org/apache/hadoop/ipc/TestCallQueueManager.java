...
public class TestCallQueueManager {
  ...
  public void testBackwardCompatibility() throws InterruptedException {
    ...
    final String ns = CommonConfigurationKeys.IPC_CALLQUEUE_NAMESPACE + ".0";
    ...
    Class<? extends BlockingQueue<FakeCall>> queue =
        (Class<? extends BlockingQueue<FakeCall>>) getQueueClass(ns,
        conf);
    ...
    // Default FCQ has 4 levels so the max capacity is 2x4
