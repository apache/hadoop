 ...
 */
public abstract class AbstractContractCopyTest extends AbstractFSContractTestBase {
  ...
  public void testZeroByteFile() throws Throwable {
    ...
    fs.delete(dstFile, false);
    // initiate copy
    fs.copyFile(zeroByteFile.toUri(), dstFile.toUri());
    // Check if file is available
  ...
  public void testFolderCopy() throws Throwable {
    ...
    handleExpectedException(intercept(Exception.class,
        () -> fs.copyFile(srcDir.toUri(), dstDir.toUri())));
  }
  ...
  public void testNonExistingParentFolder() throws Throwable {
    ...
    Path nonExistingFolder = new Path(dstDir, "test");
    Path dstFile = new Path(nonExistingFolder, "testfile");
    handleExpectedException(intercept(Exception.class,
        () -> fs.copyFile(zeroByteFile.toUri(), dstFile.toUri())));
  }
  ...
  public void testNonExistingFileCopy() throws Throwable {
    ...
    handleExpectedException(intercept(Exception.class,
        () -> fs.copyFile(srcFilePath.toUri(), dstDir.toUri())));
  }
