...
public class TestConfiguration {
  ...
  public void testStringCollectionSplitByEquals() {
    ...
    Map<String, String> splitMap =
        configuration.getTrimmedStringCollectionSplitByEquals("custom_key");
    Assertions
    ...
    splitMap = configuration.getTrimmedStringCollectionSplitByEquals("not_present");
    Assertions
        .assertThat(splitMap.size())
        .describedAs(
            "Map of key value pairs derived from config, split by equals(=) and comma(,)")
    ...
    splitMap = configuration.getTrimmedStringCollectionSplitByEquals(
        "custom_key");
    Assertions
        .assertThat(splitMap.size())
        .describedAs(
