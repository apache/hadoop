...
public class TestCryptoUtils {
  ...
  public void testProviderName() {
    Assertions.assertEquals(CryptoUtils.BOUNCY_CASTLE_PROVIDER_NAME, BouncyCastleProvider.PROVIDER_NAME);
  }

  static void assertRemoveProvider() {
    Security.removeProvider(BouncyCastleProvider.PROVIDER_NAME);
    Assertions.assertNull(Security.getProvider(BouncyCastleProvider.PROVIDER_NAME));
  }
  ...
  static void assertSetProvider(Configuration conf) {
    ...
    Assertions.assertEquals(CryptoUtils.BOUNCY_CASTLE_PROVIDER_NAME, providerFromConf);
  }
