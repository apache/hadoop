...
public abstract class GetGroupsTestBase {
  ...
  public void testNoUserGiven() throws Exception {
    ...
    UserGroupInformation currentUser = UserGroupInformation.getCurrentUser();
    assertEquals(
       getExpectedOutput(currentUser), actualOutput, "No user provided should default to current user");
  }
  ...
  public void testExistingUser() throws Exception {
    ...
    assertEquals(
       getExpectedOutput(testUser1), actualOutput, "Show only the output of the user given");
  }
  ...
  public void testMultipleExistingUsers() throws Exception {
    ...
    assertEquals(
       getExpectedOutput(testUser1) + getExpectedOutput(testUser2), actualOutput, "Show the output for both users given");
  }
