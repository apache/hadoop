...
public class TestWorkflowClosingService extends WorkflowServiceTestBase {
  ...
  public void testSimpleClose() throws Throwable {
    WorkflowClosingService<OpenClose> svc = instance(false);
  ...
  public void testNullClose() throws Throwable {
    WorkflowClosingService<OpenClose>
        svc = new WorkflowClosingService<OpenClose>(null);
  ...
  public void testCloseSelf() throws Throwable {
    WorkflowClosingService<WorkflowClosingService> svc =
        new WorkflowClosingService<WorkflowClosingService>(null);
    svc.setCloseable(svc);
    svc.stop();
  }


  private WorkflowClosingService<OpenClose> instance(boolean raiseExceptionOnClose) {
    WorkflowClosingService<OpenClose>
        svc = new WorkflowClosingService<OpenClose>(new OpenClose(
