...
public class Chain {
  ...
  private class MapRunner<KEYIN, VALUEIN, KEYOUT, VALUEOUT> extends HadoopThread {
  ...
  private class ReduceRunner<KEYIN, VALUEIN, KEYOUT, VALUEOUT> extends HadoopThread {
