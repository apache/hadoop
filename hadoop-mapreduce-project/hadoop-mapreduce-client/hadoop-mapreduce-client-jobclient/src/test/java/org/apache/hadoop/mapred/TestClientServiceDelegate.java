...
public class TestClientServiceDelegate {
  ...
  public void initTestClientServiceDelegate(boolean isAMReachableFromClient) {
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testUnknownAppInRM(boolean isAMReachableFromClient) throws Exception {
    initTestClientServiceDelegate(isAMReachableFromClient);
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testRemoteExceptionFromHistoryServer(boolean isAMReachableFromClient) throws Exception {
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testRetriesOnConnectionFailure(boolean isAMReachableFromClient) throws Exception {
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testRetriesOnAMConnectionFailures(boolean isAMReachableFromClient) throws Exception {
    initTestClientServiceDelegate(isAMReachableFromClient);
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testNoRetryOnAMAuthorizationException(boolean isAMReachableFromClient) throws Exception {
    initTestClientServiceDelegate(isAMReachableFromClient);
    if (!isAMReachableFromClient) {
      return;
    }
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testHistoryServerNotConfigured(boolean isAMReachableFromClient) throws Exception {
    initTestClientServiceDelegate(isAMReachableFromClient);
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testJobReportFromHistoryServer(boolean isAMReachableFromClient) throws Exception {
    initTestClientServiceDelegate(isAMReachableFromClient);
    MRClientProtocol historyServerProxy = mock(MRClientProtocol.class);
    when(historyServerProxy.getJobReport(getJobReportRequest())).thenReturn(
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testCountersFromHistoryServer(boolean isAMReachableFromClient) throws Exception {
    initTestClientServiceDelegate(isAMReachableFromClient);
    MRClientProtocol historyServerProxy = mock(MRClientProtocol.class);
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testReconnectOnAMRestart(boolean isAMReachableFromClient) throws IOException {
    initTestClientServiceDelegate(isAMReachableFromClient);
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testAMAccessDisabled(boolean isAMReachableFromClient) throws IOException {
    initTestClientServiceDelegate(isAMReachableFromClient);
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testRMDownForJobStatusBeforeGetAMReport(boolean isAMReachableFromClient) throws IOException {
    initTestClientServiceDelegate(isAMReachableFromClient);
    Configuration conf = new YarnConfiguration();
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testRMDownForJobStatusBeforeGetAMReportWithRetryTimes(boolean isAMReachableFromClient)
      throws IOException {
    initTestClientServiceDelegate(isAMReachableFromClient);
    Configuration conf = new YarnConfiguration();
  ...
  @MethodSource("data")
  @ParameterizedTest
  void testRMDownRestoreForJobStatusBeforeGetAMReport(boolean isAMReachableFromClient)
      throws IOException {
    initTestClientServiceDelegate(isAMReachableFromClient);
    Configuration conf = new YarnConfiguration();
