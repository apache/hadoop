...
public class TestFixedLengthInputFormat {
  ...
  @Test
  @Timeout(500000)
  void testFormatCompressedIn() throws IOException {
  ...
  @Test
  @Timeout(5000)
  void testNoRecordLength() throws IOException {
  ...
  @Test
  @Timeout(5000)
  void testZeroRecordLength() throws IOException {
    localFs.delete(workDir, true);
    Path file = new Path(workDir, new String("testFormat.txt"));
    createFile(file, null, 10, 10);
    // Set the fixed length record length config property 
  ...
  @Test
  @Timeout(5000)
  void testNegativeRecordLength() throws IOException {
    localFs.delete(workDir, true);
    Path file = new Path(workDir, new String("testFormat.txt"));
    createFile(file, null, 10, 10);
    // Set the fixed length record length config property 
  ...
  @Test
  @Timeout(5000)
  void testPartialRecordCompressedIn() throws IOException {
  ...
  @Test
  @Timeout(5000)
  void testPartialRecordUncompressedIn() throws IOException {
  ...
  @Test
  @Timeout(5000)
  void testGzipWithTwoInputs() throws IOException {
    CompressionCodec gzip = new GzipCodec();
    localFs.delete(workDir, true);
    FixedLengthInputFormat format = new FixedLengthInputFormat();
    JobConf job = new JobConf(defaultConf);
