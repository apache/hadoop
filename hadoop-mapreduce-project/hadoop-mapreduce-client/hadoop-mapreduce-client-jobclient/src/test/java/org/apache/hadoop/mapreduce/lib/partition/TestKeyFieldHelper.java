...
public class TestKeyFieldHelper {
   ...
   */
  @Test
  void testparseOption() throws Exception {
   ...
   */
  @Test
  void testGetWordLengths() throws Exception {
    KeyFieldHelper helper = new KeyFieldHelper();
    helper.setKeyFieldSeparator("\t");
   ...
   */
  @Test
  void testgetStartEndOffset() throws Exception {
    KeyFieldHelper helper = new KeyFieldHelper();
    helper.setKeyFieldSeparator("\t");
  ...
  private void testKeySpecs(String input, String expectedOutput, 
    ...
    assertEquals(expectedOutput, output, keySpecs + " failed on input '" + input + "'");
  }
