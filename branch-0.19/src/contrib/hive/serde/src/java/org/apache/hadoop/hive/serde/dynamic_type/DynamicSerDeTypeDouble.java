...
public class DynamicSerDeTypeDouble extends DynamicSerDeTypeBase {
    ...
    public Double deserialize(TProtocol iprot)  throws SerDeException, TException, IllegalAccessException {
        return new Double(iprot.readDouble());
    }
