 ...
 */
#ifndef LIB_COMMON_CONTINUATION_ASYNC_STREAM_H_
#define LIB_COMMON_CONTINUATION_ASYNC_STREAM_H_
...
namespace hdfs {
namespace async_stream_continuation {
...
public:
  ...
  virtual void Run(const Next &next) override {
    ...
    stream_->async_read(buffer_, handler);
  }
