...
public class TestBlockToken {
  ...
  private void testBadStorageIDCheckAccess(boolean enableProtobuf)
    ...
    sm.checkAccess(id, null, block3, mode, storageTypes, storageIds, new byte[0]);

    try {
      sm.checkAccess(id, null, block3, mode, storageTypes, badStorageIds, new byte[0]);
