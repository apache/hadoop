...
public class TestPBHelper {
  ...
  public void testBlockECRecoveryCommand() {
    ...
    byte[] excludeReplicatedIndices0=new byte[2];
    BlockECReconstructionInfo blkECRecoveryInfo0 = new BlockECReconstructionInfo(
        ...
        liveBlkIndices0, excludeReplicatedIndices0, StripedFileTestUtil.getDefaultECPolicy());
    ...
    byte[] excludeReplicatedIndices = new byte[2];
    BlockECReconstructionInfo blkECRecoveryInfo1 = new BlockECReconstructionInfo(
        ...
        liveBlkIndices1, excludeReplicatedIndices, StripedFileTestUtil.getDefaultECPolicy());
