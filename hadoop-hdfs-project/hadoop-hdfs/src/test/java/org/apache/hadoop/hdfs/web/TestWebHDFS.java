...
public class TestWebHDFS {
  ...
  public void testWebHdfsSnapshotDiff() throws Exception {
    ...
    DiffReportEntry entry1 =
        new DiffReportEntry(FILE, DiffType.MODIFY, DFSUtil.string2Bytes("file0"));
    DiffReportEntry entry2 =
        new DiffReportEntry(FILE, DiffType.DELETE, DFSUtil.string2Bytes("file1"));
    DiffReportEntry entry3 = new DiffReportEntry(FILE, DiffType.RENAME,
        DFSUtil.string2Bytes("file2"), DFSUtil.string2Bytes("file4"));
    DiffReportEntry entry4 =
        new DiffReportEntry(FILE, DiffType.CREATE, DFSUtil.string2Bytes("file3"));
