...
/**
 * Test BlockSyncOperationExecutor.
 */
...
public class TestBlockSyncOperationExecutor {
  ...
  public void executeMultipartPutFileSyncTask() throws Exception {
    ...
    when(multipartUploaderMock.putPart(any(), anyInt(), any(), any(),
        anyLong())).thenReturn(CompletableFuture.supplyAsync(() -> partHandle));
