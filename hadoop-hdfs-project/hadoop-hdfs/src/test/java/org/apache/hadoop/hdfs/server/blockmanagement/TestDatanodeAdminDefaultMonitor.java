...
public class TestDatanodeAdminDefaultMonitor {
  public static final Logger LOG = LoggerFactory.getLogger(TestDatanodeAdminDefaultMonitor.class);
  ...
  public void testPendingNodesQueueOrdering() {
    final PriorityQueue<DatanodeDescriptor> pendingNodes =
        new PriorityQueue<>(10,
            DatanodeAdminDefaultMonitor.PENDING_NODES_QUEUE_COMPARATOR);
  ...
  public void testPendingNodesQueueReverseOrdering() {
    ...
    final List<DatanodeDescriptor> reverseOrderNodes =
        nodes.stream().sorted(DatanodeAdminDefaultMonitor.PENDING_NODES_QUEUE_COMPARATOR.reversed())
