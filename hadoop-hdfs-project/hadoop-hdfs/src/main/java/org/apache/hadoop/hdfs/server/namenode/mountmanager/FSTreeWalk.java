...
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_PROVIDED_MOUNT_ACLS_ENABLED;
import static org.apache.hadoop.hdfs.DFSConfigKeys.DFS_PROVIDED_MOUNT_ACLS_ENABLED_DEFAULT;
...
public class FSTreeWalk extends TreeWalk {
  ...
  public FSTreeWalk(Path root, Configuration conf) throws IOException {
    ...
    boolean mountACLsEnabled = conf.getBoolean(DFS_PROVIDED_MOUNT_ACLS_ENABLED,
        DFS_PROVIDED_MOUNT_ACLS_ENABLED_DEFAULT);
  ...
  class FSTreeIterator extends TreeIterator {
    ...
    FSTreeIterator(FileStatus fileStatus, long parentId) {
      ...
      TreePath treePath = new TreePath(fileStatus, parentId, this, fs, null,
          root, acls);
