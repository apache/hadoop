...
class ErasureCodingWork extends BlockReconstructionWork {
  ...
  public ErasureCodingWork(String blockPoolId, BlockInfo block,
    ...
    for (DatanodeDescriptor datanode : getSrcNodes()) {
      datanode.incrementECBlockPendingReplicationWithoutTargets();
    }
  ...
  void chooseTargets(BlockPlacementPolicy blockplacement,
    ...
    try {
      ...
      for (DatanodeDescriptor datanode : getSrcNodes()) {
        datanode.decrementECBlockPendingReplicationWithoutTargets();
      }
    }
  }
