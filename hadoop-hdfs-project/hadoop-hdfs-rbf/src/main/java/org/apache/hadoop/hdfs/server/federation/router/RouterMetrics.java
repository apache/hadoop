...
public class RouterMetrics {
  ...
  @Metric MutableCounterLong getDelegationTokenOps;
  @Metric MutableCounterLong getDelegationTokensOps;
  @Metric MutableCounterLong renewDelegationTokenOps;
  @Metric MutableCounterLong cancelDelegationTokenOps;
