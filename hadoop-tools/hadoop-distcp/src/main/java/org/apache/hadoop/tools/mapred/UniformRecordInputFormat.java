...
public class UniformRecordInputFormat extends InputFormat<Text, CopyListingFileStatus> {
    ...
    private List<InputSplit> createSplits(Configuration configuration, int numSplits, long numRecords) throws IOException {
    ...
    private static long getNumberOfRecords(Configuration configuration) {
        return DistCpUtils.getLong(configuration, "mapred.number.of.records");
    }
