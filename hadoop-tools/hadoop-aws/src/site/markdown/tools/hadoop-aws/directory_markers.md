...
The default policy in this release of hadoop is "delete",
which _is_ backwards compatible with hadoop versions
...
The option `fs.s3a.directory.marker.retention` can be changed to "delete" to force compatibility.
