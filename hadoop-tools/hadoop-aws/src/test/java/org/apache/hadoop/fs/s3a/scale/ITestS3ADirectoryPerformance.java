  ...
  public void testListOperations() throws Throwable {
    ...
    try {
      ...
      printThenReset(LOG,
          ...
          getFileStatusCalls);
      assertEquals(
         created.getFileCount(), treewalkResults.getFileCount(), "Files found in listFiles(recursive=true) " +
      ...
      assertEquals(
         created.getFileCount(), listFilesResults.getFileCount(), "Files found in listFiles(recursive=true) " +
      ...
      assertTrue(
         rootPathSummary.getDirectoryCount() > testPathSummary.getDirectoryCount(), "Root directory count should be > test path");
      assertTrue(
         rootPathSummary.getFileCount() >= testPathSummary.getFileCount(), "Root file count should be >= to test path");
