...
public class TestS3AInputStreamRetry extends AbstractS3AMockTest {
  ...
  public void testInputStreamReadRetryForException() throws IOException {
    ...
    assertEquals(INPUT.charAt(0), s3AInputStream.read(), "'0' from the test input stream should be the first " +
        "character being read");
    assertEquals(INPUT.charAt(1), s3AInputStream.read(), "'1' from the test input stream should be the second " +
        "character being read");
  }
  ...
  public void testInputStreamReadLengthRetryForException() throws IOException {
    ...
    assertArrayEquals(
       ...
       INPUT.getBytes(), result, "The read result should equals to the test input stream content");
  }
