...
public class S3AScaleTestBase extends AbstractS3ATestBase {
  ...
  protected S3AInputStreamStatistics getInputStreamStatistics(
    ...
    } else if (inner instanceof S3EInputStream) {
      return ((S3EInputStream) inner).getS3AStreamStatistics();
    } else {
      throw new AssertionError("Not an S3AInputStream or S3EInputStream: " + inner);
    }
  }
