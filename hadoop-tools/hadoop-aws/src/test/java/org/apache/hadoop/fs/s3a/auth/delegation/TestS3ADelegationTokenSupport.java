  ...
  public void testSessionTokenDecode() throws Throwable {
    ...
    assertNotNull(
       MarshalledCredentialBinding.toAWSCredentials(creds,
        MarshalledCredentials.CredentialTypeRequired.AnyNonEmpty, ""), "credentials");
...
,         decodedUser.getAuthenticationMethod(), "Authentication method of " + decodedUser);
...
,         result.getMarshalledCredentials(), "credentials in " + ids);
