...
public class SinglePendingCommit extends PersistentCommitData<SinglePendingCommit>
  ...
  public void bindCommitData(List<CompletedPart> parts) throws ValidationFailure {
    ...
    for (CompletedPart part : parts) {
      ...
      etags.add(Etag.fromCompletedPart(part));
      counter++;
    }
  }
  ...
  public void validate() throws ValidationFailure {
    ...
    validateCollectionClass(etags, Etag.class);
    for (Etag etag : etags) {
  ...
  /**
   * Iterate over the completed parts.
   * @return an iterator.
   */
  @Override
  public Iterator<Etag> iterator() {
