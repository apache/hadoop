...
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_BYTES_COMMITTED;
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_BYTES_UPLOADED;
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_COMMITS_ABORTED;
...
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_COMMITS_FAILED;
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_COMMITS_REVERTED;
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_COMMIT_JOB;
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_JOBS_FAILED;
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_JOBS_SUCCEEDED;
...
import static org.apache.hadoop.fs.s3a.Statistic.COMMITTER_TASKS_FAILED;
...
import static org.apache.hadoop.fs.s3a.Statistic.INVOCATION_HFLUSH;
import static org.apache.hadoop.fs.s3a.Statistic.INVOCATION_HSYNC;
...
import static org.apache.hadoop.fs.s3a.Statistic.STREAM_READ_ACTIVE_MEMORY_IN_USE;
import static org.apache.hadoop.fs.s3a.Statistic.STREAM_READ_ACTIVE_PREFETCH_OPERATIONS;
import static org.apache.hadoop.fs.s3a.Statistic.STREAM_READ_BLOCKS_IN_FILE_CACHE;
...
import static org.apache.hadoop.fs.s3a.Statistic.STREAM_WRITE_BYTES;
import static org.apache.hadoop.fs.s3a.Statistic.STREAM_WRITE_EXCEPTIONS;
import static org.apache.hadoop.fs.s3a.Statistic.STREAM_WRITE_EXCEPTIONS_COMPLETING_UPLOADS;
