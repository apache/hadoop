...
public class TestAliyunOSSBlockOutputStream {
  ...
  public void setUp() throws Exception {
    ...
    conf.setInt(MULTIPART_UPLOAD_PART_SIZE_KEY, partSize);
  ...
  public void testHugeUpload() throws IOException {
    ContractTestUtils.createAndVerifyFile(fs, getTestPath(), partSize - 1);
    ContractTestUtils.createAndVerifyFile(fs, getTestPath(), partSize);
