...
public class InvalidConfigurationValueException extends AzureBlobFileSystemException {
  ...
  public InvalidConfigurationValueException(String configKey, String messaage) {
    super(String.format("Invalid configuration value detected for \"%s\". %s ", configKey, messaage));
  }
}
