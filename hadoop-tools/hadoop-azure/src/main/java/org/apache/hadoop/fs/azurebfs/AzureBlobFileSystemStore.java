  ...
  * */
  ...
  public boolean getIsNamespaceEnabled(TrackingContext trackingContext) throws AzureBlobFileSystemException {
    ...
    try (AbfsPerfInfo perfInfo = startTracking("getIsNamespaceEnabled",
        "getAclStatus")) {
      AbfsRestOperation op = client.getAclStatus(AbfsHttpConstants.ROOT_PATH, trackingContext);
  ...
  public Hashtable<String, String> getFilesystemProperties(TrackingContext trackingContext) throws AzureBlobFileSystemException {
    try (AbfsPerfInfo perfInfo = startTracking("getFilesystemProperties",
      ...
      final AbfsRestOperation op = client.getFilesystemProperties(trackingContext);
      perfInfo.registerResult(op.getResult());
  ...
  public Hashtable<String, String> getPathStatus(final Path path, TrackingContext trackingContext)
          throws AzureBlobFileSystemException {
  ...
  public void setPathProperties(final Path path, final Hashtable<String, String> properties,
  ...
  public void createFilesystem(TrackingContext trackingContext) throws AzureBlobFileSystemException {
    try (AbfsPerfInfo perfInfo = startTracking("createFilesystem", "createFilesystem")){
      ...
      final AbfsRestOperation op = client.createFilesystem(trackingContext);
      perfInfo.registerResult(op.getResult()).registerSuccess(true);
    }
  }
  ...
  public void deleteFilesystem(TrackingContext trackingContext) throws AzureBlobFileSystemException {
    try (AbfsPerfInfo perfInfo = startTracking("deleteFilesystem", "deleteFilesystem")) {
      ...
      final AbfsRestOperation op = client.deleteFilesystem(trackingContext);
      perfInfo.registerResult(op.getResult()).registerSuccess(true);
    }
  }
...
//      trackingContext.setStreamID(out.getOutputStreamID());
  ...
  public AbfsInputStream openFileForRead(final Path path, final FileSystem.Statistics statistics,
    ...
    try (AbfsPerfInfo perfInfo = startTracking("openFileForRead", "getPathStatus")) {
      ...
      final AbfsRestOperation op = client.getPathStatus(relativePath, false, trackingContext);
      perfInfo.registerResult(op.getResult());
...
//      trackingContext.setStreamID(in.getInputStreamID());
  ...
  public OutputStream openFileForWrite(final Path path, final FileSystem.Statistics statistics,
                                       final boolean overwrite, TrackingContext trackingContext) throws
...
//      trackingContext.setStreamID(out.getOutputStreamID());
  ...
  public void rename(final Path source, final Path destination, TrackingContext trackingContext) throws
          AzureBlobFileSystemException {
    ...
    do {
      try (AbfsPerfInfo perfInfo = startTracking("delete", "deletePath")) {
        AbfsRestOperation op = client.deletePath(
                relativePath, recursive, continuation, trackingContext);
        perfInfo.registerResult(op.getResult());
        continuation = op.getResult().getResponseHeader(HttpHeaderConfigurations.X_MS_CONTINUATION);
        perfInfo.registerSuccess(true);
        countAggregate++;
    ...
    try (AbfsPerfInfo perfInfo = startTracking("getFileStatus", "undetermined")) {
      ...
      if (path.isRoot()) {
        if (isNamespaceEnabled) {
          ...
          op = client.getAclStatus(getRelativePath(path), trackingContext);
        } else {
          perfInfo.registerCallee("getFilesystemProperties");
          op = client.getFilesystemProperties(trackingContext);
        }
      } else {
        perfInfo.registerCallee("getPathStatus");
        op = client.getPathStatus(getRelativePath(path), false, trackingContext);
      }
  ...
  public void setOwner(final Path path, final String owner, final String group,
    ...
    try (AbfsPerfInfo perfInfo = startTracking("setOwner", "setOwner")) {
      ...
      final AbfsRestOperation op = client.setOwner(getRelativePath(path),
              transformedOwner,
              transformedGroup, trackingContext);
  ...
  public void setPermission(final Path path, final FsPermission permission,
    ...
    try (AbfsPerfInfo perfInfo = startTracking("setPermission", "setPermission")) {
      ...
      final AbfsRestOperation op = client.setPermission(getRelativePath(path),
              String.format(AbfsHttpConstants.PERMISSION_FORMAT, permission.toOctal()), trackingContext);
  ...
  public void modifyAclEntries(final Path path, final List<AclEntry> aclSpec,
    ...
    try (AbfsPerfInfo perfInfoGet = startTracking("modifyAclEntries", "getAclStatus")) {
      ...
      final AbfsRestOperation op = client.getAclStatus(relativePath, useUpn, trackingContext);
      ...
      try (AbfsPerfInfo perfInfoSet = startTracking("modifyAclEntries", "setAcl")) {
        final AbfsRestOperation setAclOp
                ...
                AbfsAclHelper.serializeAclSpec(aclEntries), eTag, trackingContext);
  ...
  public void removeAclEntries(final Path path, final List<AclEntry> aclSpec,
    ...
    try (AbfsPerfInfo perfInfoGet = startTracking("removeAclEntries", "getAclStatus")) {
      ...
      final AbfsRestOperation op = client.getAclStatus(relativePath, isUpnFormat, trackingContext);
      perfInfoGet.registerResult(op.getResult());
      final String eTag = op.getResult().getResponseHeader(HttpHeaderConfigurations.ETAG);
  ...
  public void removeDefaultAcl(final Path path, TrackingContext trackingContext) throws AzureBlobFileSystemException {
    ...
    try (AbfsPerfInfo perfInfoGet = startTracking("removeDefaultAcl", "getAclStatus")) {
      ...
      final AbfsRestOperation op = client.getAclStatus(relativePath, trackingContext);
      perfInfoGet.registerResult(op.getResult());
      final String eTag = op.getResult().getResponseHeader(HttpHeaderConfigurations.ETAG);
      final Map<String, String> aclEntries = AbfsAclHelper.deserializeAclSpec(op.getResult().getResponseHeader(HttpHeaderConfigurations.X_MS_ACL));
  ...
  public void removeAcl(final Path path, TrackingContext trackingContext) throws AzureBlobFileSystemException {
    ...
    try (AbfsPerfInfo perfInfoGet = startTracking("removeAcl", "getAclStatus")){
      ...
      try (AbfsPerfInfo perfInfoSet = startTracking("removeAcl", "setAcl")) {
        final AbfsRestOperation setAclOp =
                client.setAcl(relativePath,
                AbfsAclHelper.serializeAclSpec(newAclEntries), eTag, trackingContext);
        perfInfoSet.registerResult(setAclOp.getResult())
                .registerSuccess(true)
                .registerAggregates(perfInfoGet.getTrackingStart(), GET_SET_AGGREGATE_COUNT);
      }
  ...
  public AclStatus getAclStatus(final Path path, TrackingContext trackingContext) throws IOException {
    ...
    try (AbfsPerfInfo perfInfo = startTracking("getAclStatus", "getAclStatus")) {
      ...
      AbfsRestOperation op = client.getAclStatus(getRelativePath(path), trackingContext);
  ...
  public void access(final Path path, final FsAction mode, TrackingContext trackingContext)
      throws AzureBlobFileSystemException {
    ...
    try (AbfsPerfInfo perfInfo = startTracking("access", "checkAccess")) {
      final AbfsRestOperation op = this.client
          .checkAccess(getRelativePath(path), mode.SYMBOL, trackingContext);
      perfInfo.registerResult(op.getResult()).registerSuccess(true);
    }
  }
