 ...
 * */
public class ContextEncryptionAdapter extends EncryptionAdapter {
   ...
   * {@link ContextEncryptionAdapter#computeKeys()} method call.
   * */
  public ContextEncryptionAdapter(EncryptionContextProvider provider, String path,
