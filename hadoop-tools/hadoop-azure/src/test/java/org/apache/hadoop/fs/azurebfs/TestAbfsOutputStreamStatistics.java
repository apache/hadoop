...
public class TestAbfsOutputStreamStatistics
  ...
  public void testAbfsOutputStreamBytesFailed() {
    ...
    assertEquals(0
,         abfsOutputStreamStatistics.getBytesUploadFailed(), "Mismatch in number of bytes failed to upload");
    ...
    assertEquals(
       randomBytesFailed, abfsOutputStreamStatistics.getBytesUploadFailed(), "Mismatch in number of bytes failed to upload");
    ...
    //Test for bytes failed to upload.
    assertEquals(
       expectedBytesFailed, abfsOutputStreamStatistics.getBytesUploadFailed(), "Mismatch in number of bytes failed to upload");
  }
  ...
  public void testAbfsOutputStreamTimeSpentOnWaitTask() {
    ...
    assertEquals(0
,         abfsOutputStreamStatistics.getTimeSpentOnTaskWait(), "Mismatch in time spent on waiting for tasks to complete");

    abfsOutputStreamStatistics
        .timeSpentTaskWait();
    //Test for one op call value of timeSpentWaitTask.
    assertEquals(
       1, abfsOutputStreamStatistics.getTimeSpentOnTaskWait(), "Mismatch in time spent on waiting for tasks to complete");
