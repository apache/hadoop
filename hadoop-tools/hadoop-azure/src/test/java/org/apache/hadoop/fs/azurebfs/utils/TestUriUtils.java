...
public final class TestUriUtils {
  ...
  public void testIfUriContainsAbfs() throws Exception {
    Assertions.assertTrue(UriUtils.containsAbfsUrl("abfs.dfs.core.windows.net"));
    Assertions.assertTrue(UriUtils.containsAbfsUrl("abfs.dfs.preprod.core.windows.net"));
    Assertions.assertFalse(UriUtils.containsAbfsUrl("abfs.dfs.cores.windows.net"));
    Assertions.assertFalse(UriUtils.containsAbfsUrl(""));
    Assertions.assertFalse(UriUtils.containsAbfsUrl(null));
    Assertions.assertFalse(UriUtils.containsAbfsUrl("abfs.dfs.cores.windows.net"));
    Assertions.assertFalse(UriUtils.containsAbfsUrl("xhdfs.blob.core.windows.net"));
  }

  @Test
  public void testExtractRawAccountName() throws Exception {
    Assertions.assertEquals("abfs", UriUtils.extractAccountNameFromHostName("abfs.dfs.core.windows.net"));
    Assertions.assertEquals("abfs", UriUtils.extractAccountNameFromHostName("abfs.dfs.preprod.core.windows.net"));
    Assertions.assertEquals(null, UriUtils.extractAccountNameFromHostName("abfs.dfs.cores.windows.net"));
    Assertions.assertEquals(null, UriUtils.extractAccountNameFromHostName(""));
    Assertions.assertEquals(null, UriUtils.extractAccountNameFromHostName(null));
    Assertions.assertEquals(null, UriUtils.extractAccountNameFromHostName("abfs.dfs.cores.windows.net"));
  }
  ...
  public void testMaskUrlQueryParameters() throws Exception {
    ...
    keyValueList = URLEncodedUtils
        .parse("abc=123&pqr=256877f2-c094-48c8-83df-ddb5825694fd&def=789",
            StandardCharsets.UTF_8);
    Assertions.assertEquals("Incorrect partial masking for guid",
    ...
    Assertions.assertEquals("Duplicate key: Both values should get masked",
    ...
    Assertions.assertEquals("Duplicate key: Values should not get masked",
    ...
    Assertions.assertEquals("Incorrect url with empty query value",
    ...
    Assertions.assertEquals("Null value, incorrect query construction",
        "abc=XXXXX&s=1&null1=",
        UriUtils.maskUrlQueryParameters(keyValueList, fullMask, partialMask));
    ...
    fullMask.add("null2");
    Assertions.assertEquals("No mask should be added for null value",
