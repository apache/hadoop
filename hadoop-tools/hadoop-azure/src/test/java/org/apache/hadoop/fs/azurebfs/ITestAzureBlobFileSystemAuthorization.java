...
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_READ_ONLY_FILE_0;
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_READ_ONLY_FILE_1;
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_READ_ONLY_FOLDER;
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_READ_WRITE_FILE_0;
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_READ_WRITE_FILE_1;
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_WRITE_ONLY_FILE_0;
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_WRITE_ONLY_FILE_1;
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_WRITE_ONLY_FOLDER;
import static org.apache.hadoop.fs.azurebfs.extensions.MockAbfsAuthorizer.TEST_WRITE_THEN_READ_ONLY;
...
public class ITestAzureBlobFileSystemAuthorization extends AbstractAbfsIntegrationTest {
  ...
  private static final Path TEST_READ_ONLY_FILE_PATH_1 =
      new Path(TEST_READ_ONLY_FILE_1);
  ...
  public void testOpenFileAuthorized() throws Exception {
    final AzureBlobFileSystem fs = this.getFileSystem();
    ((MockAbfsAuthorizer)fs.getAbfsStore().getAuthorizer()).setwriteThenReadOnly(0);
    fs.create(TEST_WRITE_THEN_READ_ONLY_PATH).close();
    ((MockAbfsAuthorizer)fs.getAbfsStore().getAuthorizer()).setwriteThenReadOnly(1);
