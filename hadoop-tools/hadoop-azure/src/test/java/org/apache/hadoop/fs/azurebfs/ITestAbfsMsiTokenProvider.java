...
public final class ITestAbfsMsiTokenProvider
  ...
  public void test() throws IOException {
    ...
    assumeThat(conf.get(FS_AZURE_ACCOUNT_OAUTH_MSI_ENDPOINT)).isNotEmpty();
    assumeThat(conf.get(FS_AZURE_ACCOUNT_OAUTH_MSI_TENANT)).isNotEmpty();
    assumeThat(conf.get(FS_AZURE_ACCOUNT_OAUTH_CLIENT_ID)).isNotEmpty();
    assumeThat(conf.get(FS_AZURE_ACCOUNT_OAUTH_MSI_AUTHORITY)).isNotEmpty();
