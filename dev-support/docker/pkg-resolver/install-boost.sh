...
default_version="1.74.0"
version_to_install=$default_version
if [ -n "$2" ]; then
  version_to_install="$2"
fi

if [ "$version_to_install" != "1.74.0" ]; then
...
if [ "$version_to_install" == "1.74.0" ]; then
  ...
  mkdir -p /opt/boost-library &&
    curl -L https://sourceforge.net/projects/boost/files/boost/1.74.0/boost_1_74_0.tar.bz2/download >boost_1_74_0.tar.bz2 &&
    mv boost_1_74_0.tar.bz2 /opt/boost-library &&
    cd /opt/boost-library &&
    tar --bzip2 -xf boost_1_74_0.tar.bz2 &&
    cd /opt/boost-library/boost_1_74_0 &&
