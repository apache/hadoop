...
//    }
  ...
  private void updateJobWithSplit(final JobConf job, InputSplit inputSplit) {
    if (inputSplit instanceof FileSplit) {
      ...
      job.set(MRConfig.MAP_INPUT_SPLITINFO, fileSplit.toString());
    }
  }
  ...
  void runNewMapper(final MapTask map,
    ...
    job.set(MRConfig.MAP_INPUT_SPLITINFO, split.toString());
  ...
  static class MapOutputBuffer<K extends Object, V extends Object>
    ...
    public MapOutputBuffer(MapTask map,
      ...
      if (LOG.isInfoEnabled()) {
        ...
        LOG.info("split details: " + job.get(MRConfig.MAP_INPUT_SPLITINFO));
      }
