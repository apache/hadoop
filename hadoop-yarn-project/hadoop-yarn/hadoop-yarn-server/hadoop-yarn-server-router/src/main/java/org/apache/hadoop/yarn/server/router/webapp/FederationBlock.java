    ...
    if (isEnabled) {
      ...
      try {
        ...
        for (SubClusterInfo subcluster : subclusters) {
          ...
          tbody.tr().td().a("//" + webAppAddress, subClusterId.toString())._()
              ...
              .td(Integer.toString(subClusterInfo.getTotalNodes()))._();
        }
      ...
      tbody._()._().div()
          .p()._("*The application counts are local per subcluster")._()._();
    } else {
