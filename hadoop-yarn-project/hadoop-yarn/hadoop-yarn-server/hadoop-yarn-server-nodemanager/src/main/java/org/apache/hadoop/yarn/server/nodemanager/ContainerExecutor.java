...
public abstract class ContainerExecutor implements Configurable {
  ...
  private List<String> whitelistVars = new ArrayList<>();
  ...
  public void setConf(Configuration conf) {
    ...
    if (conf != null) {
      whitelistVars.clear();
      whitelistVars.addAll(
          Arrays.asList(conf.get(YarnConfiguration.NM_ENV_WHITELIST,
              YarnConfiguration.DEFAULT_NM_ENV_WHITELIST).split(",")));
      // Force HADOOP_CONF_DIR into whitelistVars
