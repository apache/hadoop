...
public class TestReservations {
  ...
  private void setup(CapacitySchedulerConfiguration csConf) throws Exception {
    ...
    when(csContext.getMinimumResourceCapability()).thenReturn(
        Resources.createResource(GB, 1, 1, 1));
    when(csContext.getMaximumResourceCapability()).thenReturn(
        Resources.createResource(16 * GB, 12, 12, (1 << 12) - 1));
    when(csContext.getClusterResource()).thenReturn(
        Resources.createResource(100 * 16 * GB, 100 * 12, 100 * 12, 0));
  ...
  public void testGetAppToUnreserve() throws Exception {
    ...
    // Setup resource-requests
    Priority priorityMap = TestUtils.createMockPriority(5);
    Resource capability = Resources.createResource(2*GB, 0, 0, 0);
  ...
  public void testAssignToQueue() throws Exception {
    ...
    // absoluteMaxCapacity
    Resource capability = Resources.createResource(32 * GB, 0, 0, 0);
    ...
    capability = Resources.createResource(5 * GB, 0, 0, 0);
    ...
    assertEquals(Resources.createResource(2 * GB, 3, 3, 7), limits.getAmountNeededUnreserve());
  ...
  public void testAssignToUser() throws Exception {
    ...
    // not over the limit
    Resource limit = Resources.createResource(14 * GB, 0, 0, 0);
    ...
    limit = Resources.createResource(12 * GB, 0, 0, 0);
    ...
    // also note vcore checks not enabled
    assertEquals(Resources.createResource(1 * GB, 4, 4, 15),
