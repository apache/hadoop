  ...
  public void testCapacityScheduler() throws Exception {
    ...
    org.apache.hadoop.yarn.server.resourcemanager.NodeManager nm_0 = 
      registerNode(host_0, 1234, 2345, NetworkTopology.DEFAULT_RACK, 
          Resources.createResource(4 * GB, 1, 1, 1));
    
    // Register node2
    String host_1 = "host_1";
    org.apache.hadoop.yarn.server.resourcemanager.NodeManager nm_1 = 
      registerNode(host_1, 1234, 2345, NetworkTopology.DEFAULT_RACK, 
          Resources.createResource(2 * GB, 1, 1, 1));
    ...
    Resource capability_0_0 = Resources.createResource(1 * GB, 1, 1, 1);
    application_0.addResourceRequestSpec(priority_1, capability_0_0);
    
    Resource capability_0_1 = Resources.createResource(2 * GB, 1, 1, 1);
    ...
    Resource capability_1_0 = Resources.createResource(3 * GB, 1, 1, 1);
    application_1.addResourceRequestSpec(priority_1, capability_1_0);
    
    Resource capability_1_1 = Resources.createResource(2 * GB, 1, 1, 1);
 ...
 * @throws IOException
  ...
  public void testPreemptionInfo() throws Exception {
    ...
    waitForAppPreemptionInfo(app0,
        Resource.newInstance(CONTAINER_MEMORY * 3, 3, 3, 7), 0, 3,
        Resource.newInstance(CONTAINER_MEMORY * 3, 3, 3, 7), false, 3);
    ...
    // check values
    waitForAppPreemptionInfo(app0,
        Resource.newInstance(CONTAINER_MEMORY * 4, 4, 4, 15), 1, 3,
        Resource.newInstance(0, 0, 0, 0), false, 0);
    ...
    // check values
    waitForAppPreemptionInfo(app0,
        Resource.newInstance(CONTAINER_MEMORY * 7, 7, 7, (1 << 7) - 1), 1, 6,
        Resource.newInstance(CONTAINER_MEMORY * 3, 3, 3, (1 << 3) - 1), false, 3);
  ...
  public void testMoveAppForMoveToQueueWithFreeCap() throws Exception {
    ...
    Resource capability_1_0 = Resources.createResource(1 * GB, 1, 1, 1);
    application_1.addResourceRequestSpec(priority_1, capability_1_0);
  ...
  public void testMoveAppSuccess() throws Exception {
    ...
    NodeManager nm_0 =
        registerNode(host_0, 1234, 2345, NetworkTopology.DEFAULT_RACK,
            Resources.createResource(5 * GB, 1, 1, 1));
    ...
    Resource capability_0_0 = Resources.createResource(3 * GB, 1, 1, 1);
    application_0.addResourceRequestSpec(priority_1, capability_0_0);
  ...
  public void testMoveAppViolateQueueState() throws Exception {
    ...
    NodeManager nm_0 =
        registerNode(host_0, 1234, 2345, NetworkTopology.DEFAULT_RACK,
            Resources.createResource(6 * GB, 1, 1, 1));
  ...
  public void testAppReservationWithDominantResourceCalculator() throws Exception {
    ...
    MockNM nm1 = rm.registerNode("127.0.0.1:1234", 10 * GB, 1, 1, 1);

    // register extra nodes to bump up cluster resource
    MockNM nm2 = rm.registerNode("127.0.0.1:1235", 10 * GB, 4, 4, 15);
    rm.registerNode("127.0.0.1:1236", 10 * GB, 4, 4, 15);
  ...
  public void testApplicationHeadRoom() throws Exception {
    ...
    Assert
        .assertEquals(Resource.newInstance(0, 0, 0, 0), allocate.getResourceLimit());
    Assert.assertEquals(Resource.newInstance(0, 0, 0, 0),
        attemptMetric.getApplicationAttemptHeadroom());

    // Add a node to cluster
    Resource newResource = Resource.newInstance(4 * GB, 1, 1, 1);
  ...
  public void testHeadRoomCalculationWithDRC() throws Exception {
    ...
    Resource newResource = Resource.newInstance(10 * GB, 10, 10, (1 << 10) - 1);
    RMNode node = MockNodes.newNodeInfo(0, newResource, 1, "127.0.0.1");
    cs.handle(new NodeAddedSchedulerEvent(node));

    Resource newResource2 = Resource.newInstance(10 * GB, 10, 10, (1 << 10) - 1);
  ...
  private void verifyAMLimitForLeafQueue(CapacitySchedulerConfiguration config)
    ...
    Resource amResource =
        Resource.newInstance(amResourceLimit.getMemory() + 1,
            amResourceLimit.getVirtualCores() + 1, amResourceLimit.getGPUs() + 1, (1 << (amResourceLimit.getGPUs() + 1)) - 1);
  ...
  public void testNodemanagerReconnect() throws Exception {
    ...
    Resource capability = BuilderUtils.newResource(4096, 4, 4, (1 << 4) - 1);
