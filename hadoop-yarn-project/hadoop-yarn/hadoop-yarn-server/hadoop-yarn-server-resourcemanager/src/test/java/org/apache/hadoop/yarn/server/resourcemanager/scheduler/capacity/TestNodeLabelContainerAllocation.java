...
public class TestNodeLabelContainerAllocation {
  ...
  @Test
  void testContainerAllocationWithSingleUserLimits() throws Exception {
    ...
    am1.allocate("*", 1024, 1, new ArrayList<ContainerId>(), "");
    Assertions.assertFalse(rm1.waitForState(nm3, containerId,
          RMContainerState.ALLOCATED));
  ...
  @Timeout(300000)  
  @Test
  void testContainerAllocateWithComplexLabels() throws Exception {
    /*
     * Queue structure:
     *                      root (*)
     *                  ________________
  ...
  @Timeout(120000)
  @Test
  void testContainerAllocateWithLabels() throws Exception {
    // set node -> label
    mgr.addToCluserNodeLabelsWithDefaultExclusivity(ImmutableSet.of("x", "y"));
    mgr.addLabelsToNode(ImmutableMap.of(NodeId.newInstance("h1", 0), toSet("x"),
        NodeId.newInstance("h2", 0), toSet("y")));
    ...
    containerId =
        ContainerId.newContainerId(am1.getApplicationAttemptId(), 2);
    Assertions.assertFalse(rm1.waitForState(nm2, containerId,
        RMContainerState.ALLOCATED));
    Assertions.assertTrue(rm1.waitForState(nm1, containerId,
        RMContainerState.ALLOCATED));
    checkTaskContainersHost(am1.getApplicationAttemptId(), containerId, rm1,
  ...
  @Timeout(120000)  
  @Test
  void testContainerAllocateWithDefaultQueueLabels() throws Exception {
  ...
  @Timeout(120000)
  @Test
  void testContainerReservationWithLabels() throws Exception {
    // This test is pretty much similar to testContainerAllocateWithLabel.
    ...
    Assertions.assertTrue(schedulerApp1.getReservedContainers().size() > 0);
    Assertions.assertEquals(9 * GB, cs.getRootQueue().getQueueResourceUsage()
    ...
    Assertions.assertEquals(5 * GB, cs.getRootQueue().getQueueResourceUsage()
        .getUsed("x").getMemorySize());
    Assertions.assertEquals(0, cs.getRootQueue().getQueueResourceUsage()
        .getReserved("x").getMemorySize());
    Assertions.assertEquals(0, leafQueue.getQueueResourceUsage().getReserved("x")
        .getMemorySize());
    rm1.close();
  }
  ...
  @Timeout(120000)
  @Test
  void testContainerReservationContinueLookingWithLabels()
      throws Exception {
    // set node -> label
    ...
    Assertions.assertFalse(schedulerApp1.getReservedContainers().size() > 0);
    Assertions.assertEquals(2 * GB, cs.getRootQueue().getQueueResourceUsage()
        .getUsed("x").getMemorySize());
    ...
    Assertions.assertEquals(2, schedulerApp1.getLiveContainers().size());
    Assertions.assertFalse(schedulerApp1.getReservedContainers().size() > 0);
    Assertions.assertEquals(7 * GB, cs.getRootQueue().getQueueResourceUsage()
        .getUsed("x").getMemorySize());
    Assertions.assertEquals(0 * GB, cs.getRootQueue().getQueueResourceUsage()
        .getReserved("x").getMemorySize());
    ...
    Assertions.assertFalse(schedulerApp1.getReservedContainers().size() > 0);
    Assertions.assertEquals(12 * GB, cs.getRootQueue().getQueueResourceUsage()
        .getUsed("x").getMemorySize());
    Assertions.assertEquals(0 * GB, cs.getRootQueue().getQueueResourceUsage()
        .getReserved("x").getMemorySize());
    ...
    Assertions.assertEquals(15 * GB, cs.getRootQueue().getQueueResourceUsage()
        .getUsed("x").getMemorySize());
    Assertions.assertEquals(3 * GB, cs.getRootQueue().getQueueResourceUsage()
        .getReserved("x").getMemorySize());
    Assertions.assertEquals(15 * GB,
        leafQueue.getQueueResourceUsage().getUsed("x").getMemorySize());
  ...
  @Timeout(120000)
  @Test
  void testContainerReservationContinueLookingWithDefaultLabels()
      throws Exception {
  ...
  @Timeout(120000)
  @Test
  void testRMContainerLeakInLeafQueue() throws Exception {
    // set node -> label
    mgr.addToCluserNodeLabelsWithDefaultExclusivity(ImmutableSet.of("x"));
    mgr.addLabelsToNode(ImmutableMap.of(NodeId.newInstance("h1", 0), toSet("x"),
    ...
    Assertions.assertEquals(0, leafQueue.getIgnoreExclusivityRMContainers().size());
   ...
   */
  @Test
  void testResourceRequestUpdateNodePartitions() throws Exception {
    // set node -> label
  ...
  private void checkNodePartitionOfRequestedPriority(AppSchedulingInfo info,
    ...
    for (SchedulerRequestKey key : info.getSchedulerKeys()) {
      if (key.getPriority().getPriority() == priority) {
        Assertions.assertEquals(expectedPartition,
  ...
  @Test
  void testPreferenceOfNeedyAppsTowardsNodePartitions() throws Exception {
    /**
  ...
  @Test
  void testNonLabeledResourceRequestGetPreferrenceToNonLabeledNode()
      throws Exception {
    /**
    ...
    for (int i = 2; i < 2 + 6; i++) {
      ...
      Assertions.assertTrue(rm1.waitForState(Arrays.asList(nm1, nm2),
  ...
  @Test
  void testPreferenceOfQueuesTowardsNodePartitions()
      throws Exception {
    /**
  ...
  @Test
  void testQueuesWithoutAccessUsingPartitionedNodes() throws Exception {
    /**
     * Test case: have a following queue structure:
     * 
     * <pre>
    ...
    Assertions.assertEquals(10, cycleWaited);
  ...
  @Test
  void testAMContainerAllocationWillAlwaysBeExclusive()
      throws Exception {
    /**
    ...
    Assertions.assertEquals(0, cs.getSchedulerNode(nm1.getNodeId())
        .getNumContainers());
  ...
  void
    ...
    Assertions.assertEquals(10, schedulerNode1.getNumContainers());

    // check non-exclusive containers of LeafQueue is correctly updated
    LeafQueue leafQueue = (LeafQueue) cs.getQueue("a");
    Assertions.assertFalse(leafQueue.getIgnoreExclusivityRMContainers().containsKey(
        "y"));
  ...
  private void checkQueueUsedCapacity(String queueName, CapacityScheduler cs,
    ...
    Assertions.assertNotNull(queue, "Failed to get queue=" + queueName);

    Assertions.assertEquals(queue.getQueueCapacities()
        .getUsedCapacity(nodePartition), epsilon, usedCapacity);
    Assertions.assertEquals(queue.getQueueCapacities()
        .getAbsoluteUsedCapacity(nodePartition), epsilon, absoluteUsedCapacity);
  }
  ...
  @Test
  void testQueueUsedCapacitiesUpdate()
          throws Exception {
    /**
     * Test case: have a following queue structure:
     * 
  ...
  @Test
  void testOrderOfAllocationOnPartitions()
          throws Exception {
    /**
     * Test case: have a following queue structure:
     * 
  ...
  @Test
  void testOrderOfAllocationOnPartitionsWhenAccessibilityIsAll()
      throws Exception {
    /**
     * Test case: have a following queue structure:
     *
  ...
  @Test
  void testQueueMetricsWithLabels() throws Exception {
    /**
     * Test case: have a following queue structure:
     *
     * <pre>
    ...
    // app1 gets all resource in partition=x
    Assertions.assertEquals(5, schedulerNode1.getNumContainers());

    SchedulerNodeReport reportNm1 = rm1.getResourceScheduler()
        .getNodeReport(nm1.getNodeId());
    Assertions.assertEquals(5 * GB, reportNm1.getUsedResource().getMemorySize());
    Assertions.assertEquals(5 * GB,
        reportNm1.getAvailableResource().getMemorySize());

    SchedulerNodeReport reportNm2 = rm1.getResourceScheduler()
        .getNodeReport(nm2.getNodeId());
    Assertions.assertEquals(0 * GB, reportNm2.getUsedResource().getMemorySize());
    Assertions.assertEquals(10 * GB,
  ...
  @Test
  void testQueueMetricsWithLabelsOnDefaultLabelNode() throws Exception {
    /**
     * Test case: have a following queue structure:
     *
     * <pre>
    ...
    CSQueue rootQueue = cs.getRootQueue();
    assertEquals(rootQueue.getMetrics().getAvailableMB(), delta, 10 * GB);
    assertEquals(leafQueue.getMetrics().getAvailableMB(), delta, 2.5 * GB);
    assertEquals(leafQueueB.getMetrics().getAvailableMB(), delta, 7.5 * GB);
    ...
    assertEquals(partXMetrics.getAvailableMB(), delta, 10 * GB);
    assertEquals(partDefaultMetrics.getAvailableMB(), delta, 10 * GB);
    assertEquals(queueAPartDefaultMetrics.getAvailableMB(), delta, 2.5 * GB);
    assertEquals(queueBPartDefaultMetrics.getAvailableMB(), delta, 7.5 * GB);
    assertEquals(queueAPartXMetrics.getAvailableMB(), delta, 5 * GB);
    assertEquals(queueBPartXMetrics.getAvailableMB(), delta, 5 * GB);
    assertEquals(rootMetrics.getAvailableMB(), delta, 10 * GB);
    assertEquals(queueAMetrics.getAvailableMB(), delta, 2.5 * GB);
    assertEquals(queueBMetrics.getAvailableMB(), delta, 7.5 * GB);
    ...
    Assertions.assertEquals(3, schedulerNode1.getNumContainers());
    SchedulerNodeReport reportNm1 = rm1.getResourceScheduler()
        .getNodeReport(nm1.getNodeId());
    Assertions.assertEquals(3 * GB, reportNm1.getUsedResource().getMemorySize());
    Assertions.assertEquals(7 * GB,
        reportNm1.getAvailableResource().getMemorySize());
    SchedulerNodeReport reportNm2 = rm1.getResourceScheduler()
        .getNodeReport(nm2.getNodeId());
    ...
    Assertions.assertEquals(9 * GB,
        reportNm2.getAvailableResource().getMemorySize());
    assertEquals(partXMetrics.getAvailableMB(), delta, 7 * GB);
    assertEquals(partDefaultMetrics.getAvailableMB(), delta, 9 * GB);
    assertEquals(queueAPartDefaultMetrics.getAvailableMB(), delta, 1.5 * GB);
    assertEquals(queueAPartDefaultMetrics.getAllocatedMB(), delta, 1 * GB);
    assertEquals(queueBPartDefaultMetrics.getAvailableMB(), delta, 7.5 * GB);
    assertEquals(queueAPartXMetrics.getAvailableMB(), delta, 2 * GB);
    assertEquals(queueAPartXMetrics.getAllocatedMB(), delta, 3 * GB);
    assertEquals(queueBPartXMetrics.getAvailableMB(), delta, 5 * GB);
    assertEquals(queueAMetrics.getAllocatedMB(), delta, 1 * GB);
    assertEquals(queueAMetrics.getAvailableMB(), delta, 1.5 * GB);
    assertEquals(queueBMetrics.getAllocatedMB(), delta, 0 * GB);
    assertEquals(queueBMetrics.getAvailableMB(), delta, 7.5 * GB);
    assertEquals(queueAMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(queueAPartDefaultMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(queueAPartXMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(queueBPartDefaultMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(queueBPartXMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(leafQueue.getMetrics().getAvailableMB(), delta, 1.5 * GB);
    assertEquals(1 * GB, leafQueue.getMetrics().getAllocatedMB());
    assertEquals(partXMetrics.getAllocatedMB(), delta, 3 * GB);
    assertEquals(partDefaultMetrics.getAllocatedMB(), delta, 1 * GB);
    ...
    assertEquals(queueAUserMetrics.getAvailableMB(), delta, 2 * GB);
    assertEquals(queueAUserMetrics.getAllocatedMB(), delta, 1 * GB);
    assertEquals(queueAPartDefaultMetrics.getAvailableMB(), delta, 1.5 * GB);
    assertEquals(queueAPartDefaultMetrics.getAllocatedMB(), delta, 1 * GB);
    assertEquals(queueAPartXMetrics.getAvailableMB(), delta, 2 * GB);
    assertEquals(queueAPartXMetrics.getAllocatedMB(), delta, 3 * GB);
    assertEquals(partDefaultQueueAUserMetrics.getAvailableMB(), delta, 2 * GB);
    assertEquals(partDefaultQueueAUserMetrics.getAllocatedMB(), delta, 1 * GB);
    assertEquals(partXQueueAUserMetrics.getAvailableMB(), delta, 2 * GB);
    assertEquals(partXQueueAUserMetrics.getAllocatedMB(), delta, 3 * GB);

    am1.allocate("*", 1 * GB, 5, new ArrayList<ContainerId>());

    cs.handle(new NodeUpdateSchedulerEvent(rmNode2));

    Assertions.assertEquals(2, schedulerNode2.getNumContainers());
    Assertions.assertEquals(3, schedulerNode1.getNumContainers());
    ...
    assertEquals(queueAMetrics.getAvailableMB(), delta, 0.5 * GB);
    assertEquals(2 * GB, queueAMetrics.getAllocatedMB());
    assertEquals(queueAPartDefaultMetrics.getAvailableMB(), delta, 0.5 * GB);
    assertEquals(queueAPartDefaultMetrics.getAllocatedMB(), delta, 2 * GB);
    assertEquals(queueAPartXMetrics.getAvailableMB(), delta, 2 * GB);
    assertEquals(queueAPartXMetrics.getAllocatedMB(), delta, 3 * GB);
    assertEquals(partDefaultQueueAUserMetrics.getAvailableMB(), delta,
      1 * GB);
    assertEquals(partDefaultQueueAUserMetrics.getAllocatedMB(), delta, 2 * GB);
    assertEquals(partXQueueAUserMetrics.getAvailableMB(), delta, 2 * GB);
    assertEquals(partXQueueAUserMetrics.getAllocatedMB(), delta, 3 * GB);
    assertEquals(queueAUserMetrics.getAvailableMB(), delta, 1 * GB);
    assertEquals(queueAUserMetrics.getAllocatedMB(), delta, 2 * GB);
    assertEquals(partXMetrics.getAvailableMB(), delta, 7 * GB);
    assertEquals(partXMetrics.getAllocatedMB(), delta, 3 * GB);
    assertEquals(partDefaultMetrics.getAvailableMB(), delta, 8 * GB);
    assertEquals(partDefaultMetrics.getAllocatedMB(), delta, 2 * GB);

    // Pending Resources when containers are waiting on "default" partition
    assertEquals(queueAMetrics.getPendingMB(), delta, 4 * GB);
    assertEquals(queueAPartDefaultMetrics.getPendingMB(), delta, 4 * GB);
    assertEquals(partDefaultQueueAUserMetrics.getPendingMB(), delta,
        4 * GB);
    assertEquals(queueAUserMetrics.getPendingMB(), delta, 4 * GB);
    assertEquals(partDefaultMetrics.getPendingMB(), delta, 4 * GB);
    assertEquals(queueAPartXMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(partXQueueAUserMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(partXMetrics.getPendingMB(), delta, 0 * GB);
    ...
    assertEquals(queueAPartDefaultMetrics.getAvailableMB(), delta, 0.5 * GB);
    assertEquals(queueAPartDefaultMetrics.getAllocatedMB(), delta, 2 * GB);
    assertEquals(queueAPartXMetrics.getAvailableMB(), delta, 0 * GB);
    assertEquals(queueAPartXMetrics.getAllocatedMB(), delta, 7 * GB);
    assertEquals(partDefaultQueueAUserMetrics.getAvailableMB(), delta,
      1 * GB);
    assertEquals(partDefaultQueueAUserMetrics.getAllocatedMB(), delta, 2 * GB);
    assertEquals(partXQueueAUserMetrics.getAvailableMB(), delta, 0 * GB);
    assertEquals(partXQueueAUserMetrics.getAllocatedMB(), delta, 7 * GB);
    assertEquals(queueAUserMetrics.getAvailableMB(), delta, 1 * GB);
    assertEquals(queueAUserMetrics.getAllocatedMB(), delta, 2 * GB);
    assertEquals(partXMetrics.getAvailableMB(), delta, 3 * GB);
    assertEquals(partXMetrics.getAllocatedMB(), delta, 7 * GB);
    assertEquals(partDefaultMetrics.getAvailableMB(), delta, 8 * GB);
    assertEquals(partDefaultMetrics.getAllocatedMB(), delta, 2 * GB);
    ...
    assertEquals(partDefaultQueueAUserMetrics.getPendingMB(), delta,
        0 * GB);
    assertEquals(queueAUserMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(partDefaultMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(queueAPartXMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(partXQueueAUserMetrics.getPendingMB(), delta, 0 * GB);
    assertEquals(partXMetrics.getPendingMB(), delta, 0 * GB);
    ...
    assertEquals(queueAPartDefaultMetrics.getAvailableMB(), delta, 2.5 * GB);
    assertEquals(queueAPartXMetrics.getAvailableMB(), delta, 5 * GB);
    assertEquals(queueAUserMetrics.getAvailableMB(), delta, 3 * GB);
    assertEquals(partDefaultQueueAUserMetrics.getAvailableMB(), delta, 3 * GB);
    assertEquals(partXQueueAUserMetrics.getAvailableMB(), delta, 5 * GB);
    rm1.close();
  }

  @Test
  void testQueueMetricsWithMixedLabels() throws Exception {
    ...
    // app1 gets all resource in partition=x
    Assertions.assertEquals(6, schedulerNode1.getNumContainers());

    SchedulerNodeReport reportNm1 = rm1.getResourceScheduler()
        .getNodeReport(nm1.getNodeId());
    Assertions.assertEquals(6 * GB, reportNm1.getUsedResource().getMemorySize());
    Assertions.assertEquals(4 * GB,
        reportNm1.getAvailableResource().getMemorySize());
    ...
    // app1 gets all resource in partition=x
    Assertions.assertEquals(6, schedulerNode2.getNumContainers());
    ...
    Assertions.assertEquals(6 * GB, reportNm2.getUsedResource().getMemorySize());
  ...
  @Test
  void testTwoLevelQueueMetricsWithLabels() throws Exception {
    ...
    SchedulerNodeReport reportNm1 = rm1.getResourceScheduler()
        .getNodeReport(nm1.getNodeId());
    Assertions.assertEquals(6 * GB, reportNm1.getUsedResource().getMemorySize());
    Assertions.assertEquals(4 * GB, reportNm1.getAvailableResource().getMemorySize());
  ...
  @Test
  void testQueueMetricsWithLabelsDisableElasticity() throws Exception {
    /**
     * Test case: have a following queue structure:
     *
     * <pre>
    ...
    reportNm1 = rm1.getResourceScheduler()
        .getNodeReport(nm1.getNodeId());
    Assertions.assertEquals(10 * GB, reportNm1.getUsedResource().getMemorySize());
    Assertions.assertEquals(10 * GB,
        reportNm1.getAvailableResource().getMemorySize());
