...
public class TestAMRMRPCNodeUpdates {
  ...
  @Test
  void testAMRMDecommissioningNodes() throws Exception {
    ...
    Assertions.assertEquals(1, updatedNodes.size());
  ...
  @Test
  void testAMRMRecommissioningNodes() throws Exception {
    MockNM nm1 = rm.registerNode("127.0.0.1:1234", 10000);
    MockNM nm2 = rm.registerNode("127.0.0.2:1234", 10000);
    rm.drainEvents();
    ...
    Assertions.assertEquals(1, updatedNodes2.size());
  ...
  @Test
  void testAMRMUnusableNodes() throws Exception {
    ...
    Assertions.assertEquals(1, updatedNodes.size());
    NodeReport nr = updatedNodes.iterator().next();
    Assertions.assertEquals(nm4.getNodeId(), nr.getNodeId());
    Assertions.assertEquals(NodeState.UNHEALTHY, nr.getNodeState());
    Assertions.assertNull(nr.getDecommissioningTimeout());
    Assertions.assertEquals(NodeUpdateType.NODE_UNUSABLE, nr.getNodeUpdateType());
    ...
    Assertions.assertEquals(1, updatedNodes.size());
    nr = updatedNodes.iterator().next();
    Assertions.assertEquals(nm3.getNodeId(), nr.getNodeId());
    Assertions.assertEquals(NodeState.LOST, nr.getNodeState());
    Assertions.assertNull(nr.getDecommissioningTimeout());
    Assertions.assertEquals(NodeUpdateType.NODE_UNUSABLE, nr.getNodeUpdateType());
    ...
    nr = updatedNodes.iterator().next();
    Assertions.assertEquals(nm4.getNodeId(), nr.getNodeId());
    Assertions.assertEquals(NodeState.RUNNING, nr.getNodeState());
    Assertions.assertNull(nr.getDecommissioningTimeout());
    Assertions.assertEquals(NodeUpdateType.NODE_USABLE, nr.getNodeUpdateType());
