...
public class TestDominantResourceFairnessPolicy {
  ...
  private Comparator<Schedulable> createComparator(int clusterMem,
    ...
    policy.initialize(BuilderUtils.newResource(clusterMem, clusterCpu, 0, 0));
  ...
  private Schedulable createSchedulable(int memUsage, int cpuUsage,
    ...
    Resource usage = BuilderUtils.newResource(memUsage, cpuUsage, 0, 0);
    Resource minShare = BuilderUtils.newResource(minMemShare, minCpuShare, 0, 0);
    return new FakeSchedulable(minShare,
        Resources.createResource(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE),
  ...
  public void testUnevenWeightsSameDominantResource() {
    assertTrue(createComparator(8000, 8).compare(
        createSchedulable(3000, 1, new ResourceWeights(2.0f, 1.0f, 0.0f, 0.0f)),
        createSchedulable(2000, 1)) < 0);
    assertTrue(createComparator(8000, 8).compare(
        createSchedulable(1000, 3, new ResourceWeights(1.0f, 2.0f, 0.0f, 0.0f)),
        createSchedulable(1000, 2)) < 0);
  }
  ...
  public void testCalculateShares() {
    Resource used = Resources.createResource(10, 5, 0, 0);
    Resource capacity = Resources.createResource(100, 10, 0, 0);
