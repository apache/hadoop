...
public class TestFifoScheduler {
  ...
  public void testNodeUpdateBeforeAppAttemptInit() throws Exception {
    ...
    RMNode node = MockNodes.newNodeInfo(1,
            Resources.createResource(1024, 4, 4, 15), 1, "127.0.0.1");
  ...
  public void testBlackListNodes() throws Exception {
    ...
    ask1.add(BuilderUtils.newResourceRequest(BuilderUtils.newPriority(0),
        "rack1", BuilderUtils.newResource(GB, 1, 1, 1), 1));
    ask1.add(BuilderUtils.newResourceRequest(BuilderUtils.newPriority(0),
        ResourceRequest.ANY, BuilderUtils.newResource(GB, 1, 1, 1), 1));
  ...
  public void testHeadroom() throws Exception {
    ...
    List<ResourceRequest> ask2 = new ArrayList<ResourceRequest>();
    ask2.add(BuilderUtils.newResourceRequest(BuilderUtils.newPriority(0),
        ResourceRequest.ANY, BuilderUtils.newResource(2 * GB, 1, 1, 1), 1));
