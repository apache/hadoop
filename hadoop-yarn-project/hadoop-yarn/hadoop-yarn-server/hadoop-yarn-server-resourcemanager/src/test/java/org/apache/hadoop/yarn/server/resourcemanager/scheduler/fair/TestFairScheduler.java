...
public class TestFairScheduler extends FairSchedulerTestBase {
  ...
  public void testContainerReservationAttemptExceedingQueueMax()
    ...
    out.println("<maxResources>2048mb,5vcores 5 gpus</maxResources>");
    out.println("</queue>");
    out.println("<queue name=\"queue2\">");
    out.println("<maxResources>2048mb,10vcores 10 gpus</maxResources>");
    out.println("</queue>");
    out.println("</queue>");
    out.println("</allocations>");
    out.close();
  ...
  public void testContainerReservationNotExceedingQueueMax() throws Exception {
    ...
    out.println("<queue name=\"root\">");
    out.println("<queue name=\"queue1\">");
    out.println("<maxResources>3072mb,10vcores,10gpus</maxResources>");
    out.println("</queue>");
    out.println("<queue name=\"queue2\">");
