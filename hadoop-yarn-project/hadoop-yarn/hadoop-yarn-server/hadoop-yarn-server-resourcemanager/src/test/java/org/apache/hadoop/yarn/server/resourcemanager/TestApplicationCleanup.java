...
public class TestApplicationCleanup {
  ...
  @Test
  void testAppCleanup() throws Exception {
    GenericTestUtils.setRootLogLevel(Level.DEBUG);
  ...
  @Test
  void testContainerCleanup() throws Exception {
  ...
  @SuppressWarnings("resource")
  @Timeout(60000)  @Test
  void testAppCleanupWhenRMRestartedAfterAppFinished() throws Exception {
  ...
  @SuppressWarnings("resource")
  @Timeout(60000)  @Test
  void testAppCleanupWhenRMRestartedBeforeAppFinished() throws Exception {
    conf.setInt(YarnConfiguration.RM_AM_MAX_ATTEMPTS, 1);
  ...
  @Timeout(60000)
  @Test
  void testContainerCleanupWhenRMRestartedAppNotRegistered() throws
      Exception {
    conf.setInt(YarnConfiguration.RM_AM_MAX_ATTEMPTS, 1);
    // start RM
    MockRM rm1 = new MockRM(conf);
  ...
  @Timeout(60000)
  @Test
  void testAppCleanupWhenNMReconnects() throws Exception {
    conf.setInt(YarnConfiguration.RM_AM_MAX_ATTEMPTS, 1);
  ...
  // container.
  @Timeout(60000)  @Test
  void testProcessingNMContainerStatusesOnNMRestart() throws Exception {
    conf.setInt(YarnConfiguration.RM_AM_MAX_ATTEMPTS, 1);
