...
public class TestRMHAMetrics {
  ...
  @Timeout(300000)
  @Test
  void testMetricsAfterTransitionToStandby() throws Exception {
    ...
    Assertions.assertEquals((String) mbs.getAttribute(mxbeanName,
        "State"), "initializing");
    ...
    Assertions
        .assertEquals((String) mbs.getAttribute(mxbeanName,
            "State"), "active");
