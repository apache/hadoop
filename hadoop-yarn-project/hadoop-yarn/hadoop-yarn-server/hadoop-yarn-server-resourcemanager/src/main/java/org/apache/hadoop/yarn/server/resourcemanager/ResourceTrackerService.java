  ...
  public RegisterNodeManagerResponse registerNodeManager(
    ...
    String message =
        "NodeManager from node " + host + "(cmPort: " + cmPort + " httpPort: "
            ...
            + ", assigned nodeId " + nodeId +  ", localUsedPorts: " + rmNode.getLocalUsedPortsSnapshot() + " , available Port:"+ rmNode.getAvailablePorts() + ", containerAllocated Port:" + rmNode.getAvailablePorts();
    LOG.info(message);
