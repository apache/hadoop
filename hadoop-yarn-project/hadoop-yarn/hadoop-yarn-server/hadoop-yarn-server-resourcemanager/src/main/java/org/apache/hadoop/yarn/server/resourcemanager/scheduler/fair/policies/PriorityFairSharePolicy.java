...
@Private
@Unstable
public class PriorityFairSharePolicy extends SchedulingPolicy {
  @VisibleForTesting
  public static final String NAME = "fair";
  private static final Logger LOG =
      LoggerFactory.getLogger(PriorityFairSharePolicy.class);
  ...
  private static class FairShareComparator implements Comparator<Schedulable>,
    ...
    public int compare(Schedulable s1, Schedulable s2) {
      ...
      if (res == 0) {
        res = s1.getPriority().compareTo(s2.getPriority());
      }
