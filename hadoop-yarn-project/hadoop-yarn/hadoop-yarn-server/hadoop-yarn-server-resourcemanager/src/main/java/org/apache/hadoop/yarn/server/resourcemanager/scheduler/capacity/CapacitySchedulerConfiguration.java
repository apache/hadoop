...
public class CapacitySchedulerConfiguration extends ReservationSchedulerConfiguration {
  ...
  public String getRootAutoscalerMinimumCapacity() {
    return get(getQueuePrefix(ROOT_PATH) + AUTOSCALER_MINIMUM_CAPACITY, "");
  }

  public String getRootAutoscalerMaximumCapacity() {
    return get(getQueuePrefix(ROOT_PATH) + AUTOSCALER_MAXIMUM_CAPACITY, "");
  }

  public void setRootAutoscalerMinimumCapacity(String minCapacity) {
    this.set(getQueuePrefix(ROOT_PATH) + AUTOSCALER_MINIMUM_CAPACITY, minCapacity);
  }

  public void setRootAutoscalerMaximumCapacity(String maxCapacity) {
    this.set(getQueuePrefix(ROOT_PATH) + AUTOSCALER_MAXIMUM_CAPACITY, maxCapacity);
  }
