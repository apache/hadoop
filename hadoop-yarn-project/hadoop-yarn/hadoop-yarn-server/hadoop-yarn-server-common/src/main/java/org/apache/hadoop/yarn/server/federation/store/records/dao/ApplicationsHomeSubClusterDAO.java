...
public class ApplicationsHomeSubClusterDAO {
  protected List<ApplicationHomeSubClusterDAO> appHomes;

  public ApplicationsHomeSubClusterDAO() {
  } // JAXB needs this

  public ApplicationsHomeSubClusterDAO(
      List<ApplicationHomeSubCluster> appHomes) {
    this.appHomes = new ArrayList<>();
    for (ApplicationHomeSubCluster appHome : appHomes) {
      this.appHomes.add(new ApplicationHomeSubClusterDAO(appHome));
    }
  }

  public List<ApplicationHomeSubCluster> toApplicationsHome() {
    List<ApplicationHomeSubCluster> ret = new ArrayList<>();
