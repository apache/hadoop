...
import org.apache.hadoop.yarn.federation.proto.YarnServerFederationProtos.RouterUpdateStoredTokenResponseProtoOrBuilder;
import org.apache.hadoop.yarn.server.federation.store.records.RouterStoreToken;
import org.apache.hadoop.yarn.server.federation.store.records.RouterUpdateStoredTokenRequest;

public class RouterUpdateStoredTokenResponsePBImpl extends RouterUpdateStoredTokenRequest {

  private RouterUpdateStoredTokenResponseProto proto = RouterUpdateStoredTokenResponseProto.getDefaultInstance();
  private RouterUpdateStoredTokenResponseProto.Builder builder = null;
  private boolean viaProto = false;
  private RouterStoreToken routerStoreToken = null;

  public RouterUpdateStoredTokenResponsePBImpl() {
    builder = RouterUpdateStoredTokenResponseProto.newBuilder();
  }

  public RouterUpdateStoredTokenResponsePBImpl(RouterUpdateStoredTokenResponseProto requestProto) {
    this.proto = requestProto;
    viaProto = true;
  }

  public RouterUpdateStoredTokenResponseProto getProto() {
    mergeLocalToProto();
  ...
  private void maybeInitBuilder() {
    if (viaProto || builder == null) {
      builder = RouterUpdateStoredTokenResponseProto.newBuilder(proto);
    }
    viaProto = false;
  }
  ...
  public RouterStoreToken getRouterStoreToken() {
    RouterUpdateStoredTokenResponseProtoOrBuilder p = viaProto ? proto : builder;
    if (this.routerStoreToken != null) {
