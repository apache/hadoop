...
public class TestYarnUncaughtExceptionHandler {
  ...
  void testUncaughtExceptionHandlerWithRuntimeException()
    ...
    final Thread yarnThread = new HadoopThread(new Runnable() {
      @Override
      public void run() {
        throw yarnException;
      }
  ...
  void testUncaughtExceptionHandlerWithError()
    ...
    final Thread errorThread = new HadoopThread(new Runnable() {
      @Override
      public void run() {
        throw error;
      }
  ...
  void testUncaughtExceptionHandlerWithOutOfMemoryError()
    ...
    final Thread oomThread = new HadoopThread(new Runnable() {
      @Override
      public void run() {
        throw oomError;
      }
