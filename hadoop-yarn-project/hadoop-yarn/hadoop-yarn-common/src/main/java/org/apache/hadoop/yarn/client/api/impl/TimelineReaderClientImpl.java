...
public class TimelineReaderClientImpl extends TimelineReaderClient {
  ...
  protected Response doGetUri(URI base, String path,
    ...
    WebTarget webTarget = connector.getClient()
        .target(base)
        .path(path);
    ...
    if (resp == null
      ...
      String msg = "Response from the timeline reader server is " + ((resp == null) ?
          "null" : "not successful, HTTP error code: " + resp.getStatus()
