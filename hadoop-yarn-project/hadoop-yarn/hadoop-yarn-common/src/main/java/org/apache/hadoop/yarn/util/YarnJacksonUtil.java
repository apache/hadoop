 ...
 * <p>
 * This is a copy of the JacksonUtil class from hadoop-common. It is copied here
 * because some CI testing uses old copies of hadoop-common that do not have that
 * JacksonUtil class.
 * </
 */
@Private
public final class YarnJacksonUtil {
